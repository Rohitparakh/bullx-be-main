...
const sell = (mint, amount, prvKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = yield token_1.default.findOne({ prvKey: prvKey, mint });
    if (token) {
        ...
        try {
            yield token_1.default.updateOne({ prvKey: prvKey, mint }, { amount: newTokenAmount, sold });
        }
        catch (error) {
            console.log(error);
    ...
    yield user_1.default.updateOne({ prvKey: prvKey }, { solBalance: newSolBalance });
    return { success: true };
});
exports.sell = sell;
...
const buy = (mint, amount, prvKey) => __awaiter(void 0, void 0, void 0, function* () {
    const tokenData = yield (0, pump_1.getTokenDetails)(mint);
    if (!tokenData)
        return { success: false, msg: "No token detail" };
    const liquidityPools = Object.values(tokenData.liquidityPools);
    ...
    if (token) {
        ...
        try {
            yield token_1.default.updateOne({ prvKey: prvKey, mint }, { amount: newTokenAmount, invested });
        }
        catch (error) {
            console.log(error);
